...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(146, 199, 59, 1);
  ...
  static Color splash_screen_color = Color.fromRGBO(146, 199, 59, 1); // if not sure , use the same color as accent color
